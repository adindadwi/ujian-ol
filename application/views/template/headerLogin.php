<!-- <title>Ujian Online SMP</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta charset="utf-8">
	<meta name="keywords" content="ujian online siswa SMP" />
	<script>
	...
	<link href="<?php echo base_url(); ?>assets/bootstrap/css/fontawesome-all.min.css" rel="stylesheet"> -->
	<!-- //Custom Theme files -->
	<!-- online fonts -->
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav text-center  ml-lg-auto">
						<li class="nav-item active  mr-3">
							<a class="nav-link" href="<?php base_url('index')?>">Home -->
								<!-- <span class="sr-only">(current)</span> -->
							</a>
						<!-- </li>
						<li class="nav-item  mr-3">
							<a class="nav-link" href="<?php echo site_url('/c_sigup');?>">Register</a>
						</li>
						<li class="nav-item  mr-3">
